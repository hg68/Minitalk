...
/*   Updated: 2022/06/17 16:49:39 by hgill            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c == 's')
		ft_string(va_arg(*args, char *), l);
	else if (c == 'd' || c == 'i')
		ft_number(va_arg(*args, int), l);
	else if (c == 'u')
		ft_unsigned_int(va_arg(*args, unsigned int), l);
	else if (c == 'x')
		ft_hexadecimal(va_arg(*args, unsigned int), l, 'x');
	else if (c == 'X')
		ft_hexadecimal(va_arg(*args, unsigned int), l, 'X');
	else if (c == 'p')
		ft_pointer(va_arg(*args, size_t), l);
	else if (c == 'c')
